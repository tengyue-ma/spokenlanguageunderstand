...
SRC_NAME=NNClassifier
UNIT_TEST_CPP=NNClassifier_UnitTest.cpp
SRC_CPP=../../classifier/clf_nn/src/${SRC_NAME}.cpp
...
-I ../../classifier/clf_nn/tensorflow/include/google/tensorflow/  \
-I ../../classifier/clf_nn/tensorflow/include/eigen3/  \
...
-L ../../classifier/clf_nn/tensorflow/lib/ -ltensorflow_all \
