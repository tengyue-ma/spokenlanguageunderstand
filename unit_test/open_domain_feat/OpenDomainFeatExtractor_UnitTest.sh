...
cd unit_test/open_domain_feat

SRC_NAME=OpenDomainFeatExtractor
UNIT_TEST_CPP=OpenDomainFeatExtractor_UnitTest.cpp
SRC_CPP=../../feat_extractor/open_domain_feat/src/${SRC_NAME}.cpp
OTHER_CPP=../../feat_extractor/open_domain_feat/src/slotType.cpp
OTHER_NAME=slotType
